...
public class ProviderUtil {
    ...
    public static String getScript(String dbType, String methodName, ClassTableColumnInfo tableColumnInfo) {
        ...
        SqlSource sqlSource = XML_LANGUAGE_DRIVER_LAZY.get().createSqlSource(CONFIGURATION_LAZY.get(), script, Map.class);
    ...
    private static void readTemplateFromResource(URL url) {
        try (Stream<Path> paths = Files.find(Paths.get(url.toURI()), 2, (path, basicFileAttributes) -> basicFileAttributes.isRegularFile())
