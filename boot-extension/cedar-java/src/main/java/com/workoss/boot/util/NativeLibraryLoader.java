...
public class NativeLibraryLoader {
	...
	public synchronized void loadLibrary(final String tmpDir, final String libName) throws IOException {
	...
	void loadLibrary(final String tmpDir, final String jniLibraryFileName, final String fallbackJniLibraryFileName)
			throws IOException {
		if (initialized) {
			return;
		}
		String libraryFilePath = loadLibraryFile(tmpDir, jniLibraryFileName, fallbackJniLibraryFileName)
			.getAbsolutePath();
	...
	File loadLibraryFile(final String tmpDir, final String jniLibraryFileName, final String fallbackJniLibraryFileName)
			throws IOException {
