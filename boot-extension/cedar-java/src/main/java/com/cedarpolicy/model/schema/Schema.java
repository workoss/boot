...
public final class Schema {
	...
	/**
	 * Build a Schema from a string containing the JSON source for the model. This
	 * constructor will fail with an exception if the string does not parse as JSON, but
	 * it does not check that the parsed JSON object represents a valid schema.
	...
	/**
	 * Build a Schema from a json node. This does not check that the parsed JSON object
	 * represents a valid schema.
	 * @param schemaJson List of EntityTypes.
	 */
