...
//        EvaluateResult evaluate = engine.evaluate(String.format(expressionTpl, expression).getBytes(StandardCharsets.UTF_8), JsonMapper.parse(input));
