...
public enum DatabaseType {
	...
	HSQLDB("hsqldb"), H2("h2"), MYSQL("mysql") {
	...
	private static final Map<DatabaseDriver, DatabaseType> DATABASE_DRIVER_TO_DATABASE_TYPE_MAP = Map.of(
			DatabaseDriver.H2, H2, DatabaseDriver.HSQLDB, HSQLDB, DatabaseDriver.POSTGRESQL, POSTGRES,
