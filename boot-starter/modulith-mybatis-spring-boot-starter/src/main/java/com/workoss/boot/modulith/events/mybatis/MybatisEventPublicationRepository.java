...
class MybatisEventPublicationRepository implements EventPublicationRepository {
    ...
    public List<EventPublication> findIncompletePublications() {
        List<Map<String, Object>> mapList = dynamicDao.executeQuery(SQL_STATEMENT_FIND_UNCOMPLETED, Collections.emptyMap());
    ...
    public Optional<EventPublication> findIncompletePublicationsByEventAndTargetIdentifier(Object event, PublicationTargetIdentifier targetIdentifier) {
        ...
        params.put("serializedEvent", serializer.serialize(event));
        List<Map<String, Object>> mapList = dynamicDao.executeQuery(SQL_STATEMENT_FIND_BY_EVENT_AND_LISTENER_ID, params);
        if (mapList == null || mapList.isEmpty()) {
    ...
    private static class MybatisEventPublication implements EventPublication {
        ...
        public MybatisEventPublication(UUID id, Instant publicationDate, String listenerId, String serializedEvent, Class<?> eventType, EventSerializer serializer, @Nullable Instant completionDate) {
        ...
        public int hashCode() {
            return Objects.hash(new Object[]{this.completionDate, this.eventType, this.id, this.listenerId, this.publicationDate, this.serializedEvent, this.serializer});
        }
    }
}
