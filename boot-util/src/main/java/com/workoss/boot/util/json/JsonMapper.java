...
public class JsonMapper {
	...
	public JsonMapper(JsonInclude.Include include) {
		...
		boolean existJdk8 = ClassUtils.isPresent("com.fasterxml.jackson.datatype.jdk8.Jdk8Module", null);
		if (existJdk8) {
			mapper.registerModule(new Java8Module().getModule());
		}
	}
	...
	public static <T> List<T> parseArray(byte[] json, Class<T> tClass) {
		return parseObject(json, build().buildCollectionType(ArrayList.class, tClass));
	}
