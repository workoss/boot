...
public class Sequence {
    ...
    public Sequence(LocalDateTime epochDate, long workerId, long datacenterId,
                    boolean useSystemClock, long timeOffset, long randomSequenceLimit) {
        ...
        logger.info("[SNOWFLAKE] datacenterId:{} workerId:{} twepoch:{} useSystemClock:{} timeOffset:{} randomSequenceLimit:{}",
