...
public class SqlInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (ReflectUtils.getFieldValue(boundSql, MYBATIS_METAPARAMETERS) != null) {
            MetaObject metaObject = (MetaObject) ReflectUtils.getFieldValue(boundSql, MYBATIS_METAPARAMETERS);
            ReflectUtils.setFieldValue(newBoundSql, MYBATIS_METAPARAMETERS, metaObject);
        }
        ...
        if (additionalParamters != null) {
            Map<String, Object> map = (Map<String, Object>) additionalParamters;
            ReflectUtils.setFieldValue(newBoundSql, MYBATIS_ADDITIONALPARAMTERS, map);
        }
