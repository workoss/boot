...
public abstract class AbstractMethodAccess {
    ...
    public int getIndex(String methodName, Class... paramTypes) {
        ...
        throw new IllegalArgumentException("Unable to find non-private method: " + methodName + " " + Arrays
				.toString(paramTypes));
    }
     ...
     */
    static public AbstractMethodAccess get(Class type) {
        ...
        String accessClassName = className + "AbstractMethodAccess";
            ...
            synchronized (loader) {
                try {
                    ...
                    cw.visit(V1_8, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null,
                            "com/workoss/boot/util/reflect/AbstractMethodAccess", null);
                    {
                        mv = cw.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
                        mv.visitCode();
                        mv.visitVarInsn(ALOAD, 0);
                        mv.visitMethodInsn(INVOKESPECIAL, "com/workoss/boot/util/reflect/AbstractMethodAccess", "<init>", "()V", false);
                        mv.visitInsn(RETURN);
                        mv.visitMaxs(0, 0);
                        mv.visitEnd();
                    }
        ...
        try {
            AbstractMethodAccess access = (AbstractMethodAccess) accessClass.newInstance();
